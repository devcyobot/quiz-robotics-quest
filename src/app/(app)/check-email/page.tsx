...
const CheckEmailPage: FC = () => {
  return (
    <main className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <section className="container bg-brand-purple-dark rounded-xl shadow-lg p-4 w-auto sm:w-2/3 lg:w-1/2 max-h-400:h-[90%] h-2/3 sm:h-1/3 md:h-4/5 lg:h-1/2 max-h-[30rem] overflow-autoflex flex-col justify-between transform transition-all duration-300">
